...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/yephm/nav',
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'https://yephm.github.io/nav',

  // 网站标题
  title: '学习Plus - 精选实用导航网站',

  // 网站描述
  description: '学习Plus - 精选实用导航网站',
  ...
  footerContent: `
    ...
    <div>Copyright © 2021-2031 yephm, All Rights Reserved</div>
  `,
